...
function TeacherList() {
    ...
    const [isFilterVisable, setIsFiltersVisible] = useState(false);
    ...
    function loadFavorites() {
        AsyncStorage.getItem('favorites').then(resp => {
            if (resp) {
                ...
                const favoritedTechersIds = favoritedTeacher.map((teacher: Teacher) => {
                    return teacher.id;
                })
    ...
    function handleToggleFiltersVisible() {
        setIsFiltersVisible(!isFilterVisable);
    }
